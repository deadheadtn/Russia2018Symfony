 ...
 * Reclamation
 *
 * @ORM\Table(name="reclamation", uniqueConstraints={@ORM\UniqueConstraint(name="ID_UTILISATEUR", columns={"ID_UTILISATEUR"})}, indexes={@ORM\Index(name="FK_FAIRE", columns={"ID_UTILISATEUR"}), @ORM\Index(name="FK_SUIVRE", columns={"ID_FOLLOWUP"})})
 * @ORM\Entity
 */
class Reclamation
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="ID_FOLLOWUP", referencedColumnName="ID_FOLLOWUP")
     * })
     */
    private $idFollowup;
